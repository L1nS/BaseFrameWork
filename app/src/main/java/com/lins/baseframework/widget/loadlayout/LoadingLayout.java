package com.lins.baseframework.widget.loadlayout;
...
public class LoadingLayout extends FrameLayout {
    ...
    public LoadingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mStateView = a.getResourceId(R.styleable.LoadingLayout_stateView, R.layout.widget_loadlayout_loadstate);
            mLoadingView = a.getResourceId(R.styleable.LoadingLayout_loadingView, R.layout.widget_loadlayout_loading);
            mEmptyView = a.getResourceId(R.styleable.LoadingLayout_emptyView, R.layout.widget_loadlayout_empty);

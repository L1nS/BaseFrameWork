 ...
 */
package com.lins.baseframework.utils.okgo.callback;

import com.google.gson.stream.JsonReader;
import com.lins.baseframework.utils.okgo.response.HttpResponse;
import com.lins.baseframework.utils.okgo.response.SimpleResponse;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != HttpResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                HttpResponse httpResponse = Convert.fromJson(jsonReader, type);
                response.close();
...
//                    throw new IllegalStateException(httpResponse.msg + "code:" + httpResponse.code);
                    throw new IllegalStateException(httpResponse.msg);
                }
            }
        }

...
public class StorageManager {
    ...
    public static String getAppRootDir() {
        String path = Environment.getExternalStorageDirectory() + "/" + Constants.DOWNLOAD_FOLDER;
    ...
    public static String getPatchDir() {
        String path = Environment.getExternalStorageDirectory() + "/" + Constants.DOWNLOAD_FOLDER + "/patch";
        File file = new File(path);
        if (!file.exists()) {
            file.mkdirs();
        }

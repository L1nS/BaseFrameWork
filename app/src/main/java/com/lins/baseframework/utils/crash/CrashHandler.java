...
//            System.exit(1);
    ...
    public void autoClear(final int autoClearDay) {
        MyFileUtils.delete(getGlobalpath(), new FilenameFilter() {

            @Override
            public boolean accept(File file, String filename) {
                String s = MyFileUtils.getFileNameWithoutExtension(filename);
                int day = autoClearDay < 0 ? autoClearDay : -1 * autoClearDay;
                String date = "crash-" + MyDateUtils.getOtherDay(day);
